...
japan_prefecture_df = pd.read_csv("D:\FPT Software\Population & Economic Indicators\CSV Sources\Japan Prefecture - Acute Accent Removed.csv",encoding='latin1')
# japan_prefecture_df = pd.read_csv("/content/drive/MyDrive/FPT /Japan Prefecture - Acute Accent Removed.csv", 
...
usa_state_df = pd.read_csv("D:\\FPT Software\\Population & Economic Indicators\\CSV Sources\\USA - States and Cities.csv",encoding='latin1')
# usa_state_df = pd.read_csv("/content/drive/MyDrive/FPT /USA - States and Cities.csv",engine='python')
...
usa_state_df = usa_state_df.reindex(columns=['country_code','country_name' ,'area','population','prefecture'])

japan_population = pd.merge(result_df, japan_prefecture_df, how='inner', on=['area','country_code'])
# japan_population = pd.merge(result_df, japan_prefecture_df, left_on = ['area','country_code'], right_on = ['area','country_code'], how = 'left')


# reorder columns
japan_population = japan_population.reindex(columns=['country_code','country_name' ,'area','population','prefecture'])
...
malay_state_df = pd.read_csv("D:\FPT Software\Population & Economic Indicators\CSV Sources\Malaysia cities and states.csv",encoding='latin1')

#malay_state_df = pd.read_csv('/content/drive/MyDrive/FPT /Malaysia cities and states.csv',
#            names=['area','prefecture'], sep=' *, *', skiprows=1,engine='python')
...
# reorder columns
malay_population = malay_population.reindex(columns=['country_code','country_name' ,'area','population','prefecture'])
...
population.to_csv('General population based on areas')
japan_population.to_csv('Japan population based on areas')
usa_state_df.to_csv('USA population based on areas')
malay_population.to_csv('Malaysia population based on areas')
...
# import test case
test_case = pd.read_csv("D:/FPT Software/Population & Economic Indicators/CSV Sources/test_case.csv",encoding='latin1')
#test_case = pd.read_csv('/content/drive/MyDrive/FPT /test_case.csv', engine = 'python')
...
# reset columns order
usa_state_pop = usa_state_pop.reindex(columns=['country_code','country_name','population','prefecture/state'])
...
# reset columns order
japan_pre_population = japan_pre_population.reindex(columns=['country_code','country_name','population','prefecture/state'])
...
# reset columns order
malay_state_pop_df = malay_state_pop_df.reindex(columns=['country_code','country_name','population','prefecture/state'])
...
# reset columns order
population_pre = population_pre.reindex(columns=['country_code','country_name','population','prefecture/state','updated_at'])
...
# import test case
test_case_pre = pd.read_csv("D:/FPT Software/Population & Economic Indicators/CSV Sources/test_case_pre.csv",encoding='latin1')

#test_case_pre = pd.read_csv('/content/drive/MyDrive/FPT /test_case_pre.csv', engine = 'python')
...
population_pre.to_csv('General population based on prefecture or state')
japan_pre_population.to_csv('Japan population based on prefecture or state')
usa_state_pop.to_csv('USA population based on prefecture or state')
malay_state_pop_df.to_csv('Malaysia population based on prefecture or state')
total.to_csv('Total population')
